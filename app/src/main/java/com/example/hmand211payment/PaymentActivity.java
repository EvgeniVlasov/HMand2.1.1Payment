package com.example.hmand211payment;
...
public class PaymentActivity extends AppCompatActivity {
    ...
    EditText mEditInfo;
    CheckBox mBankCard;
    CheckBox mNumberPhone;
    CheckBox mCashAddress;
    Button mPaymentOk;
        ...
        mPaymentOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mEditMoney.getText().toString().isEmpty()) {
                    ...
                    Toast.makeText(PaymentActivity.this, "Оплата произведена", Toast.LENGTH_SHORT).show();
                }
            }
        });
